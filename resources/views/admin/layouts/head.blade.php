...
{{-- <link rel="manifest" href="{{ asset('template/base-website/assets/img/favicons/manifest.json') }}"> --}}
...
<link rel="stylesheet" href="{{ asset('template/base-admin/dist/assets/modules/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')}}">
